...
* Студент: [Светлана Хохлова](https://up.htmlacademy.ru/htmlcss/18/user/222815).
* Наставник: `Один в поле воин`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/222815-technomart) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
